					...
					<div class="col-md-6" data-aos="fade-up">
						...
						<form id="ContactForm">
							<div class="form-group clearfix">
								<div class="row"><div class="col-md-12"><input name="name" type="text" placeholder="Name" class="form-control"></div></div>
							</div>
							<div class="form-group clearfix">
								<div class="row"><div class="col-md-6"><input name="email" type="email" placeholder="Email" class="form-control"></div>
								<div class="col-md-6"><input name="phone" type="number" placeholder="Phone" class="form-control"></div></div>
							</div>
							<div class="form-group clearfix">
								<div class="row"><div class="col-md-12"><textarea name="message" class="form-control" placeholder="Message"></textarea></div></div>
							</div>

							<div id="mailStatus" class="alert" role="alert"></div>

							<div class="form-group clearfix">
								<div class="row"><div class="col-md-12"><button id="SendBtn" class="btn-sub"><span>Send</span></button></div></div>
							</div>
						</form>
					</div>
					<div class="col-md-6" data-aos="fade-up">
