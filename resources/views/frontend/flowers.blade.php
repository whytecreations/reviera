						...
						<div class="col-md-3">
							<div id="sidebar" class="sidebar">
								...
								<ul data-aos="fade-up">
									...
									<li><a
											href="{{url('flowers/'.$flowerCategory->slug)}}">{{$flowerCategory->name}}</a>
									</li>
									@endforeach
								</ul>
							</div>
						...
						<div class="pd_rgt">
							...
							<h4>{{$flower->title}}
								...
								<a href="javascript:void(0);" style="color:tomato"
									onclick="addFlowerToWishList('{{$flower->id}}','{{$flower->title}}','{{asset($flower->getMedia('images')->first()->getUrl())}}')"
								...
								<ul>
									...
									<li class="clearfix">
										<div class="radio"><input id="{{$flower->id}}-radio-1" name="size" value="big"
												...
												class="radio-label">Big Size</label></div>
									...
									<li class="clearfix">
										<div class="radio"><input id="{{$flower->id}}-radio-2" name="size" value="small"
												...
												class="radio-label">Small Size</label>
										</div>
