						...
						<div class="col-md-3">
							<div id="sidebar" class="sidebar">
								...
								<ul data-aos="fade-up">
									...
									<li><a
											href="{{url('chocolates/'.$chocolateCategory->slug)}}">{{$chocolateCategory->name}}</a>
									</li>
									@endforeach
								</ul>
							</div>
						...
						<div class="pd_rgt">
							...
							<h4>{{$chocolate->title}}
								...
								<a href="javascript:void(0);" style="color:tomato"
									onclick="addChocolateToWishList('{{$chocolate->id}}','{{$chocolate->title}}','{{asset($chocolate->getMedia('images')->first()->getUrl())}}')"
