						...
						<tbody>
							<tr>
								<td width="55%" align="left">
									<div class="wd"><a href="#"><i class="fa fa-heart-o"></i></a><a href="#"><i
					...
					<div class="pd_rgt">
						...
						<div class="price">
							<div class="input-group quantity">
								<span class="input-group-btn"><button type="button" class="btn btn-minus btn-number"
								...
								<span class="input-group-btn"><button type="button" class="btn btn-plus btn-number"
